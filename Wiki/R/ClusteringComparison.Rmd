...
plot(iris[,c(1,2)], col=model$cluster, main="Fuzzy C-Means")
points(model$centers[,c(1,2)], col=1:3, pch=8, cex=2)
...
plot(iris[,c(1,2)], col=model$classification, main="Multi-Gaussian with Expectation-Maximization")

#  -------- Density-based 

library(fpc)
model <- dbscan(iris[,1:4], eps=0.6, MinPts=4)
plot(iris[,c(1,2)], col=model$cluster, main="Density-based")
...
model <- cutree(hc, 3)
plot(iris[,c(1,2)], col=model, main="Hierarchical")
...
plot(iris[,c(1,2)], col=model, main="Self-Organising Maps")
